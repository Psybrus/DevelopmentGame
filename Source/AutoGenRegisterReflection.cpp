...
void AutoGenRegisterReflection()
{
	...
	ScnShaderImportParams::StaticRegisterClass();
	...
	ScnShaderBloomUniformBlockData::StaticRegisterClass();
	...
	GaTestCloudBlockData::StaticRegisterClass();
	...
	GaTrailComponent::StaticRegisterClass();
}
